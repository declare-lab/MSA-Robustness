...
class MOSI:
    def __init__(self, config):
        ...
        CACHE_PATH = DATA_PATH + '/mult_embedding_and_mapping.pt'

        # If cached data if already exists
        try:
            self.train = load_pickle(DATA_PATH + '/mult_train.pkl')
            self.dev = load_pickle(DATA_PATH + '/mult_dev.pkl')
            self.test = load_pickle(DATA_PATH + '/mult_test.pkl')
            ...
            # Save pickles
            to_pickle(train, DATA_PATH + '/mult_train.pkl')
            to_pickle(dev, DATA_PATH + '/mult_dev.pkl')
            to_pickle(test, DATA_PATH + '/mult_test.pkl')
