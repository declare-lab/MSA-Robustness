        ...
        while True: 
            ...
            with tqdm(dataloader['train']) as td:
                for batch_data in td:
                    ...
                    model.Model.args.is_train            = model.training
                    model.Model.args.is_test             = self.args.is_test
                    model.Model.args.train_method        = self.args.train_method
                    model.Model.args.train_changed_modal = self.args.train_changed_modal
                    model.Model.args.train_changed_pct   = self.args.train_changed_pct
                    model.Model.args.test_method         = self.args.test_method
                    model.Model.args.test_changed_modal  = self.args.test_changed_modal
                    model.Model.args.test_changed_pct    = self.args.test_changed_pct
